 ...
 */
final class Version20201019121952 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE links (id INT NOT NULL, link TEXT NOT NULL, short_link VARCHAR(1024) DEFAULT NULL, PRIMARY KEY(id))');
